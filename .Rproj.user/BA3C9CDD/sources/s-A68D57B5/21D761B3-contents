  ...
  navbarPage(inverse=TRUE,
             ...
             tabPanel("IWA",
                      fluidPage(id = "navbar",
                                ...
                                h5("(c) In tab (Model) the user inputs the observed data and Jags sampling characteristics. A basic inference plot is presented."),
                                ...
                                br(),
                                h5("Open: 1. MULTIPLE+TRUE(+ZERO), 2. Fix sliders SE+SP(+tau0) TRUE+MULTIPLE(+ZERO), 3. Organize Diagnostics MULTIPLE, 4. Slicker error jags in TRUE+MULTIPLE(+ZERO)"),
                                hr(),
